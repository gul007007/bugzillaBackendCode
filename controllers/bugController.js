...
//   const { bugId, newStatus } = req.body;

//   try {
//     const bug = await Bug.findByIdAndUpdate(bugId, { status: newStatus }, { new: true });
//     if (!bug) {
//       return res.status(404).json({ error: "Bug not found" });
//     }

//     // No notification sent to QA
...
//   const { bugId, qaStatus } = req.body;

//   try {
//     const bug = await Bug.findByIdAndUpdate(bugId, { qaStatus }, { new: true });
//     if (!bug) {
//       return res.status(404).json({ error: "Bug not found" });
//     }

//     // No notification sent to managers
//     res.status(200).json({ message: "QA status updated" });
//   } catch (error) {
//     res.status(500).json({ error: "An error occurred" });
//   }
// };
